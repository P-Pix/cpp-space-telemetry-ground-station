...
\textbf{Objectif.} Ce manuel permet de suivre precisement le chemin d'execution du programme depuis chaque ligne de commande jusqu'aux fonctions C++ appelees. Il documente egalement les validations, les threads, les sockets, les formats binaires, les effets de bord, les garanties et les limites de la version de reference du projet.
}}
\end{minipage}
\vfill
{\large Documentation technique de revue et d'entretien}\par
\vspace{0.2cm}
{\small Version de reference : projet STGS modulaire}\par
\end{center}
\clearpage
